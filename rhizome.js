...
export class Rhizome {
  ...
  get(args, knex) { // processes one data node at once

	if(!knex){
		return false; // knex connector needs to be supplied, currently
	}
  ...
  getRelatedBranches(args, knex){

  }

  updateRelatedBranches(args, knex){
