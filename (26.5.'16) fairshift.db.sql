...
CREATE TABLE IF NOT EXISTS `cache` (
  ...
  `_` int(11) unsigned NOT NULL,
  `usage_count` int(11) unsigned NOT NULL,
  `__` int(11) unsigned NOT NULL,
...
--
-- Table structure for table `node_cache`
--
...
CREATE TABLE IF NOT EXISTS `node_cache` (
  ...
  `line_id` int(11) unsigned NOT NULL,
  `language_id` int(11) unsigned NOT NULL,
  `horizon` tinyint(1) unsigned NOT NULL,
  `nodes` text NOT NULL,
  `_` int(11) unsigned NOT NULL,
  `usage_count` int(11) unsigned NOT NULL,
  `__` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `value_system_metric` (
  `id` int(11) unsigned NOT NULL,
  `value_system_id` int(11) unsigned NOT NULL,
  `title` varchar(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `_project_outcome` (
  `id` int(11) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `resource` (
  ...
  `description` varchar(512) NOT NULL,
  `energy` tinyint(1) unsigned NOT NULL,
  `matter` tinyint(1) unsigned NOT NULL,
  `_` int(1) unsigned NOT NULL,
  `created_by_user_id` int(11) unsigned NOT NULL,
  `created_by_entity_id` int(11) unsigned NOT NULL,
  `time_created` int(11) unsigned NOT NULL,
...
--
-- Table structure for table `site_placeholder`
--

CREATE TABLE IF NOT EXISTS `site_placeholder` (
  `id` int(11) unsigned NOT NULL,
  `site_id` int(11) unsigned NOT NULL,
...
--
ALTER TABLE `language`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT3;
--
...
ALTER TABLE `node`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `node_cache`
--
ALTER TABLE `node_cache`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `site_content`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `site_placeholder`
--
ALTER TABLE `site_placeholder`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
