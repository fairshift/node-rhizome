/*
  ...
  ****************************
  ...
  - clarity to a person looking to understand ...
  - as well as to define programmaticly data structures and functionalities ...
  ...
  # Collection: Multilingual data structure

*/

  language = { node: ['multilingual'], containsMany: {
...
*/
  ...
  var units = { // units of measurement (attach a versioning process to establish new agreements, using +rhizome)
      unit: 'node+privileges+multilingual', // eg.: unit of (time or energy) used to form an (object and/or experience)
